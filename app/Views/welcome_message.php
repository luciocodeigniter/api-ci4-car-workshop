...
<body>
    ...
    <header>
        ...
        <div class="heroe">
            ...
            <h1>Vehicle Mechanical Workshop API <br>
                created with Codeigniter with the version <br>4.4.4</h1>
    ...
    <section>
        ...
        <h2 class="code-line" data-line-start=1 data-line-end=2><a id="API_for_creating_customers_their_cars_their_addresses_creating_services_and_employees_Creation_of_customer_vehicle_maintenance_with_Codeigniter_4_The_API_provides_registration_and_authentication_1"></a>API for creating customers, their cars, their addresses, creating services and employees. Creation of customer vehicle maintenance with Codeigniter 4. The API provides registration and authentication.</h2>
        <h2 class="code-line" data-line-start=4 data-line-end=5><a id="Features_4"></a>Features</h2>
        <ul>
            <li class="has-line-data" data-line-start="6" data-line-end="7">Register</li>
            <li class="has-line-data" data-line-start="7" data-line-end="8">Login</li>
            <li class="has-line-data" data-line-start="8" data-line-end="9">CRUD Customers</li>
            <li class="has-line-data" data-line-start="9" data-line-end="10">CRUD Cars customers</li>
            <li class="has-line-data" data-line-start="10" data-line-end="11">CRUD Address customers</li>
            <li class="has-line-data" data-line-start="11" data-line-end="12">CRUD Employees</li>
            <li class="has-line-data" data-line-start="12" data-line-end="13">CRUD Services</li>
            <li class="has-line-data" data-line-start="13" data-line-end="14">CRUD Maintenance cars</li>
            <li class="has-line-data" data-line-start="14" data-line-end="16">CRUD Services Maintenance cars association</li>
        </ul>
        <h2 class="code-line" data-line-start=16 data-line-end=17><a id="Server_Requirements_16"></a>Server Requirements</h2>
        <ul>
            <li class="has-line-data" data-line-start="17" data-line-end="18">Developed PHP 8.2.7 and Codeigniter 4.4.4</li>
            <li class="has-line-data" data-line-start="18" data-line-end="20">The following extensions need to be enabled:</li>
        </ul>
        <ol>
            <li class="has-line-data" data-line-start="20" data-line-end="21">intl</li>
            <li class="has-line-data" data-line-start="21" data-line-end="22">mbstring</li>
            <li class="has-line-data" data-line-start="22" data-line-end="24">json</li>
        </ol>
        <h2 class="code-line" data-line-start=16 data-line-end=17><a id="Installation_16"></a>Installation</h2>
        <p class="has-line-data" data-line-start="18" data-line-end="19">1 - Install the project using composer (requires <a href="https://getcomposer.org/">Composer</a>):</p>
        <pre><code class="has-line-data" data-line-start="21" data-line-end="23" class="language-sh">composer create-project luciocodeigniter/api-ci4-car-workshop
</code></pre>
        <p class="has-line-data" data-line-start="25" data-line-end="26">2 - Rename the <strong>.env-exemple.txt</strong> file to <strong>.env</strong> which can be found in the project root</p>
        <p class="has-line-data" data-line-start="27" data-line-end="28">3 - Place the information in the <strong>.env</strong> file as per the following example:</p>
        <pre><code class="has-line-data" data-line-start="30" data-line-end="62" class="language-sh"><span class="hljs-comment">#--------------------------------------------------------------------</span>
...
app.baseURL = <span class="hljs-string">'https://exemplo.com/'</span>
app.indexPage = <span class="hljs-string">''</span>
...
database.default.port = <span class="hljs-number">3306</span>


<span class="hljs-comment">#--------------------------------------------------------------------</span>
<span class="hljs-comment"># JWT Authenticator</span>
<span class="hljs-comment">#--------------------------------------------------------------------</span>
authjwt.keys.default.<span class="hljs-number">0</span>.secret = oGPvp9lLkgTvcqlVIU3rJE46uJmedapcW3EJ6cr/<span class="hljs-number">9</span>gw=
</code></pre>
        <h2 class="code-line" data-line-start=63 data-line-end=64><a id="Creating_and_populating_tables_in_the_database_63"></a>Creating and populating tables in the database.</h2>
        <p class="has-line-data" data-line-start="65" data-line-end="66">1 - At the root of the project, open the terminal and run the following command:</p>
        <pre><code class="has-line-data" data-line-start="67" data-line-end="69" class="language-sh">php spark api:init
</code></pre>
        <p class="has-line-data" data-line-start="70" data-line-end="71">2 . If you want to reset the database to its original state, simply run the following command in the root of the project:</p>
        <pre><code class="has-line-data" data-line-start="72" data-line-end="74" class="language-sh">php spark api:reset
</code></pre>
        <p class="has-line-data" data-line-start="75" data-line-end="76">3 - If you want to change the number of records to be created with seeders, simply change the TOTAL_STEPS constant within each file, which can be found in app\Database\Seeds:</p>
        <pre><code class="has-line-data" data-line-start="77" data-line-end="87" class="language-sh">
//...

/**
* How many records <span class="hljs-keyword">do</span> you want to create
*/
private const TOTAL_STEPS = <span class="hljs-number">100</span>; //&lt;---- Change here

//..
</code></pre>
        <h2 class="code-line" data-line-start=88 data-line-end=89><a id="Registering_on_the_application_88"></a>Registering on the application</h2>
        <p class="has-line-data" data-line-start="90" data-line-end="91">1 . Send a <strong>POST</strong> request to <strong>https://exemplo.com/api/register</strong></p>
        <p class="has-line-data" data-line-start="92" data-line-end="93">If the request was validated, you should see the <strong>access_token</strong> in the response:</p>
        <pre><code class="has-line-data" data-line-start="94" data-line-end="98" class="language-sh">{
    <span class="hljs-string">"access_token"</span>: <span class="hljs-string">"eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJpc3MiOiI8SXNzdWVyIG9mIHRoZSBKV1Q-Iiwic3ViIjoiMSIsImlhdCI6MTcwNjMxMDI5NSwiZXhwIjoxNzA2MzEzODk1fQ.G8SaDs_vaMqFnzELllLbfErKSUvYiofNoGzhMYQkqUg"</span>
}
</code></pre>
        <p class="has-line-data" data-line-start="99" data-line-end="100">When making all future requests to the API, the client should send the JWT in the Authorization header as a Bearer token.</p>
        <h2 class="code-line" data-line-start=101 data-line-end=102><a id="Authenticating_in_the_application_101"></a>Authenticating in the application</h2>
        <p class="has-line-data" data-line-start="103" data-line-end="104">1 . Send a <strong>POST</strong> request to <strong>https://exemplo.com/api/login</strong></p>
        <p class="has-line-data" data-line-start="105" data-line-end="106">If the request was validated, you should see the <strong>access_token</strong> in the response:</p>
        <pre><code class="has-line-data" data-line-start="107" data-line-end="111" class="language-sh">{
    <span class="hljs-string">"access_token"</span>: <span class="hljs-string">"eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJpc3MiOiI8SXNzdWVyIG9mIHRoZSBKV1Q-Iiwic3ViIjoiMSIsImlhdCI6MTcwNjMxMDI5NSwiZXhwIjoxNzA2MzEzODk1fQ.G8SaDs_vaMqFnzELllLbfErKSUvYiofNoGzhMYQkqUg"</span>
}
</code></pre>
        <p class="has-line-data" data-line-start="112" data-line-end="113">When making all future requests to the API, the client should send the JWT in the Authorization header as a Bearer token.</p>
        <h2 class="code-line" data-line-start=114 data-line-end=115><a id="_Customers_endpoints_114"></a>- Customers endpoints</h2>
        <h3 class="code-line" data-line-start=116 data-line-end=117><a id="List_all_116"></a>List all</h3>
        <pre><code class="has-line-data" data-line-start="118" data-line-end="120" class="language-sh">GET https://exemplo.com/api/customers
</code></pre>
        <h3 class="code-line" data-line-start=121 data-line-end=122><a id="Get_single_121"></a>Get single</h3>
        <pre><code class="has-line-data" data-line-start="123" data-line-end="125" class="language-sh">GET https://exemplo.com/api/customers/<span class="hljs-number">1</span>
</code></pre>
        <h3 class="code-line" data-line-start=126 data-line-end=127><a id="Create_126"></a>Create</h3>
        <pre><code class="has-line-data" data-line-start="128" data-line-end="130" class="language-sh">POST https://exemplo.com/api/customers
</code></pre>
        <h3 class="code-line" data-line-start=131 data-line-end=132><a id="Update_131"></a>Update</h3>
        <pre><code class="has-line-data" data-line-start="133" data-line-end="135" class="language-sh">PUT or PATCH https://exemplo.com/api/customers/<span class="hljs-number">1</span>
</code></pre>
        <h3 class="code-line" data-line-start=136 data-line-end=137><a id="Delete_136"></a>Delete</h3>
        <pre><code class="has-line-data" data-line-start="138" data-line-end="140" class="language-sh">DELETE https://exemplo.com/api/customers/<span class="hljs-number">1</span>
</code></pre>
        <h2 class="code-line" data-line-start=141 data-line-end=142><a id="_Others_endpoints_141"></a>- Others endpoints</h2>
        <pre><code class="has-line-data" data-line-start="143" data-line-end="149" class="language-sh">https://exemplo.com/api/cars
